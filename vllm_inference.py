...
MODEL_REVISION = "288e64a6ddb4467a0d802b2a3ea00e2888e5eb84"
...
app = modal.App("datadrivet-vllm-openai-compatible")

N_GPU = 2  # tip: for best results, first upgrade to more powerful GPUs, and only then increase GPU count
TOKEN = "imposing-lavish-pushiness-everyday-approve-cornstalk-capillary-dosage"  # auth token. for production use, replace with a modal.Secret
